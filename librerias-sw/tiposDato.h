...
typedef enum {
	LEER, CREAR, ESCRIBIR, BORRAR, CREARDIR, BORRARDIR, RENOMBRAR, ERROR,GETATTR,LEERDIR,SGETATTR,SLEERDIR,SLEER,VACIO,ERROREDQUOT,ERRORENAMETOOLONG,ERRORESPACIO,TRUNCAR
} protocoloPokedex_t;
typedef enum {
	ENTRENADOR_MAPA,
	MAPA_ENTRENADOR,
